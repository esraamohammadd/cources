 ...
 * Use the {@link VideoesFragment#newInstance} factory method to
...
public class VideoesFragment extends Fragment {
     ...
     * @return A new instance of fragment VideoesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static VideoesFragment newInstance(String subject_name, String param2) {
       ...
       View view = inflater.inflate(R.layout.fragment_videoes, container, false);
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AddFragment addFragment = AddFragment.newInstance(msubjectName);
                FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
                addFragment.show(fragmentManager,null);
